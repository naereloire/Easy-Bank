...
import './finance.css';
import '../../styledComponents/styledComponents';
	...
	return (
		<>
			...
			<Popup
				trigger={
					<button>
						4 passos pra autônomos se organizarem e sobrar dinheiro
					</button>
				}
			...
			<Popup
				trigger={<button>5 hábitos de riqueza pra adotar HOJE!</button>}
				position='right center'>
				<div className='.popup-content'>
					<ul>
